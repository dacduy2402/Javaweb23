...
public class SecureConf extends WebSecurityConfigurerAdapter{
	...
	protected void configure(final HttpSecurity http) throws Exception {
		...
		.antMatchers("/css/**", "/js/**", "/upload/**", "/img/**", "/login", "/logout", "/registry").permitAll()
...
//		.defaultSuccessUrl("/admin/home", true) // login thành công thì luôn trở về trang người dùng
	...
	public static void main(String[] args) {
		...
		System.out.println(new BCryptPasswordEncoder(4).encode("Guest123"));
	}
}
