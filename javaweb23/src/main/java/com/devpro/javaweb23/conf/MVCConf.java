...
@Configuration	//Báo spring biết đây là file cấu hình
public class MVCConf implements WebMvcConfigurer{
	...
	public void addResourceHandlers(final ResourceHandlerRegistry registry) {
		...
		//bất cứ request nào có dạng: http://localhost:8080/css/styles.css sẽ vào folder src/main/resources/css
		...
		registry.addResourceHandler("/upload/**").addResourceLocations("file:" + "/Users/mrduy/DevPro_JavaWeb/upload/");		
	}
	...
	@Bean	//Báo spring biết foldẻ chứa view
	public ViewResolver viewResolver() {

		// Class InternalResourceViewResolver implements ViewResolver
		InternalResourceViewResolver bean = new InternalResourceViewResolver();

		// thiết lập view engine dùng để đọc data từ controller trả về và trộn vs code html
		bean.setViewClass(JstlView.class);

		// Đường dẫn thư mực gốc chứa Views.
		bean.setPrefix("/WEB-INF/views/");//đường dẫn tới folder chứa views
