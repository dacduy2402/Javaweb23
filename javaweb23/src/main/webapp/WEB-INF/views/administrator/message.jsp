			...
			<div class="col-12 down">
				<div class="col-2 sidebar">
					<ul>
						...
						<li id="default"><a href="#"> <span class="material-symbols-sharp">mail_outline</span>
								<h3>Message</h3>
						</a></li>
				...
				<div class="col-10 list-products" id="listProduct">
					<%-- <form action="${base }/admin/message" method="get">
						<div class="col-7 search">
							<!-- số trang sản phẩm -->
							<input id="page" name="page" class="form-control"
								value="${paging.page }" style="margin-right: 5px;">
							<!-- Tim kiem theo ten -->
							<input type="search" id="keyword" name="keyword"
								class="form-control" placeholder="Search"
								value="${paging.keyword }" autocomplete="off">
