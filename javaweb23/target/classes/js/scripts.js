...
function PostContactUsingAjax(baseUrl) {
	// tạo javascript object để binding với data bên phía controller  
	var requestBody = {
		name	: jQuery("#idName").val(),
		email		: jQuery("#idEmail").val(),
		subject		: jQuery("#idSubject").val(),
		message		: jQuery("#idMessage").val(),
	};
	
	// $ === jQuery
	// json == javascript object
	jQuery.ajax({
		url: baseUrl + "/ajax/contact",	   //-> request mapping định nghĩa bên controller
